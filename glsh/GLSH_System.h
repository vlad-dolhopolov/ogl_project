...
#define GLSH_CHECK_GL_ERRORS(label)              CheckGLErrors(label, __FUNCTION__, __FILE__, __LINE__)
#define GLSH_CHECK_GL_SHADER(shader_id, label)   CheckGLShader(shader_id, label, __FUNCTION__, __FILE__, __LINE__)
#define GLSH_CHECK_GL_PROGRAM(prog_id, label)    CheckGLProgram(prog_id, label, __FUNCTION__, __FILE__, __LINE__)
